...
<!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Airline Management</h1>
        ...
        <div class="row">
            <div class="col-xl-6 col-md-6 mb-6">
                ...
                <div class="card shadow mb-6">
                    ...
                    <div class="card-body">
                     <form class="user" method="POST" action="{{ route('addAirline') }}">
                        @csrf

                        <div class="form-group">
                            <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }} form-control-user" id="exampleInputName" aria-describedby="emailHelp" placeholder="Enter Airline Name..."  name="name" value="{{ old('name') }}" required autofocus>
                            @if ($errors->has('name'))
